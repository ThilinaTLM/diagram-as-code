...
app = FastAPI(
    title="Graph as Code Online", description="Generate diagrams from Python code"
)
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        try:
            ...
            if os.path.exists(png_file):
                ...
                return (
                    None,
                    "No diagram file was generated. Make sure your code creates a Diagram.",
                )
...
async def execute_diagram(request: Request):
    ...
    try:
        ...
        if "application/json" in content_type:
            ...
            if not code:
                raise HTTPException(
                    status_code=400, detail="No code provided in JSON body"
                )
        else:
        ...
        if img_data:
            return StreamingResponse(
                ...
                headers={
                    "Content-Disposition": "inline; filename=executed_diagram.png"
                },
            )
        else:
